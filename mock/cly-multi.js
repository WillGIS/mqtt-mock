...
// var client_up1 = mqtt.connect('mqtt://' + broker, {
//     'clientId': 'sunic_cly_' + Math.random().toString(16).substr(2, 8),
//     'deviceId': 'aaa1'
//     // 'deviceId': deviceArray
// });

// var client_up2 = mqtt.connect('mqtt://' + broker, {
//     'clientId': 'sunic_cly_' + Math.random().toString(16).substr(2, 8),
//     'deviceId': 'aaa2'
//     // 'deviceId': deviceArray
// });

// client_up1.on('connect', () => {
//     console.log(client_up1.options.deviceId);
//     client_up1.subscribe('cly_0_up');

// });
// client_up2.on('connect', () => {
//     console.log(client_up2.options.deviceId);
// });
